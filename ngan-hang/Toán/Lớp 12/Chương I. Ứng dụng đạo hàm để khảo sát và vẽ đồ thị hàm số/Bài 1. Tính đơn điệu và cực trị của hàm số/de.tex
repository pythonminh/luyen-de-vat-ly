...
```
% Khung bảng
\draw (0,0) rectangle (6.8,2.7);

% Các đường ngang
\draw (0,1.7) -- (6.8,1.7);
\draw (0,0.75) -- (6.8,0.75);
...
% Hàng x
\node at (1.0,2.25) {$-\infty$};
\node at (2.6,2.25) {$-\dfrac43$};
\node at (4.2,2.25) {$\dfrac12$};
\node at (5.5,2.25) {$+\infty$};
...
% Hàng f
\node at (1.0,0.35) {$-\infty$};
\node at (2.6,0.35) {$\nearrow$};
\node at (4.2,0.35) {$\searrow$};
\node at (5.5,0.35) {$\nearrow$};

% Mũi tên biến thiên
\draw[->,thick] (1.25,0.32) -- (2.35,0.32);
\draw[->,thick] (2.85,0.32) -- (3.95,0.32);
\draw[->,thick] (4.45,0.32) -- (5.25,0.32);
```
...
{\True Hàm số đồng biến trên khoảng $\left(-\dfrac{4}{3};\dfrac{1}{2}\right)$}
{Hàm số nghịch biến trên khoảng $\left(\dfrac{7}{2};+\infty\right)$}
{Hàm số đồng biến trên khoảng $\left(-\infty;-\dfrac{7}{3}\right)$}

\loigiai{
Dựa vào bảng biến thiên ta thấy hàm số đồng biến trên các khoảng
$\left(-\infty;-\dfrac{4}{3}\right)$ và
