...
\begin{ex}Cho hình vuông $MNPQ$ tâm $H$, có cạnh bằng $1$. Tính độ dài vectơ $\overrightarrow{u}=\overrightarrow{HQ}-\overrightarrow{HP}$.
\choice
{\True 1}
{$\frac{\sqrt{2}}{2}$}
{$\sqrt{2}$}
{$\sqrt{3}$}
\loigiai{
Để tính độ dài vectơ $\overrightarrow{u}=\overrightarrow{HQ}-\overrightarrow{HP}$, ta sử dụng quy tắc trừ vectơ. Theo quy tắc này, $\overrightarrow{HQ}-\overrightarrow{HP} = \overrightarrow{PQ}$.
Vậy, $\overrightarrow{u} = \overrightarrow{PQ}$.
Độ dài của vectơ $\overrightarrow{u}$ chính là độ dài của đoạn thẳng $PQ$. Vì $MNPQ$ là hình vuông có cạnh bằng $1$, nên độ dài cạnh $PQ$ là $1$.
Do đó, $|\overrightarrow{u}| = |\overrightarrow{PQ}| = PQ = 1$.
Chọn đáp án A.
}
\end{ex}
