...
{$\sqrt{3}$}
\loigiai{
Để tính độ dài vectơ $\overrightarrow{u}=\overrightarrow{HQ}-\overrightarrow{HP}$, ta sử dụng quy tắc trừ vectơ.
 Theo quy tắc này, $\overrightarrow{HQ}-\overrightarrow{HP} = \overrightarrow{PQ}$.
