...
{B. Số 10 là số chẵn.}
{C. $2 + 3 = 6$.}
{D. Có một số nguyên tố lớn nhất.}
\loigiai{
Một mệnh đề toán học là một khẳng định có thể xác định được tính đúng hoặc sai (đúng hoặc sai, không thể cả hai). Các câu B, C, D đều là các khẳng định có thể xác định được tính đúng/sai (B đúng, C sai, D sai). Riêng câu A: $x + 2 > 5$ là một mệnh đề chứa biến. Tính đúng sai của nó phụ thuộc vào giá trị của $x$. Do đó, nó không phải là một mệnh đề toán học.
}
\end{ex}
