...
%=== Câu 4 (ID: 0D1N1-1) ===%
\begin{ex}%[Đoàn Minh Tâm]%[Bộ đề 4 phần lớp 10]%[0D1N1-1]
...
%=== Câu 5 (ID: 0D1N1-2) ===%
\begin{ex}%[Đoàn Minh Tâm]%[Bộ đề 4 phần lớp 10]%[0D1N1-2]
...
%=== Câu 6 (ID: 0D1N2-1) ===%
\begin{ex}%[Đoàn Minh Tâm]%[Bộ đề 4 phần lớp 10]%[0D1N2-1]
...
%=== Câu 8 (ID: 0D1H1-1) ===%
\begin{ex}%[Đoàn Minh Tâm]%[Bộ đề 4 phần lớp 10]%[0D1H1-1]
...
%=== Câu 25 (ID: 0D1H1-3) ===%
\begin{ex}%[Đoàn Minh Tâm]%[Bộ đề 4 phần lớp 10]%[0D1H1-3]
...
%=== Câu 26 (ID: 0D1H1-4) ===%
\begin{ex}%[Đoàn Minh Tâm]%[Bộ đề 4 phần lớp 10]%[0D1H1-4]
...
%=== Câu 33 (ID: 0D1H1-5) ===%
\begin{ex}%[Đoàn Minh Tâm]%[Bộ đề 4 phần lớp 10]%[0D1H1-5]
	Chọn mệnh đề đúng.
	\choice
...
\begin{ex}%[Đoàn Minh Tâm]%[Bộ đề 4 phần lớp 10]%[0D1H1-5]
	...
	\loigiai{
		\begin{itemchoice}
			\item \lq\lq $\forall x\in \mathbb{R}$, $x^3-x^2+1>0$\rq\rq ~là mệnh đề sai.\\
			Vì với $ x=-1 $, ta có $ (-1)^3-(-1)^2+1=-1<0 $.
			\item \lq\lq $\exists n\in \mathbb{N}$, $n^2+3$ chia hết cho $4$\rq\rq ~ là mệnh đề đúng.\\
			Vì có $ n=1 $ thì $ 1^2+3=4 $ chia hết cho $ 4 $.
			\item $P\colon$ \lq\lq $\forall x\in \mathbb{R}$, $\forall y\in \mathbb{R}\colon x+y=1$ \rq\rq  ~ là mệnh đề sai.
			Vì với $x=2{,}5$; $y=1\Rightarrow P(2{,}5;1)$ là mệnh đề sai.
			\item $Q\colon$\lq\lq $\exists x\in \mathbb{R},\exists y\in \mathbb{R}\colon x+y=2$\rq\rq  ~ là mệnh đề đúng.
...
%=== Câu 37 (ID: 0D1H2-1) ===%
\begin{ex}%[Đoàn Minh Tâm]%[Bộ đề 4 phần lớp 10]%[0D1H2-1]
...
%=== Câu 39 (ID: 0D1V1-6) ===%
\begin{ex}%[Đoàn Minh Tâm]%[Bộ đề 4 phần lớp 10]%[0D1V1-6]
...
%=== Câu 41 ===%
\begin{ex}%[Đoàn Minh Tâm]%[Bộ đề 4 phần lớp 10]%[0D1C1-6]
