%=== Câu 5 (ID: None) ===%
\begin{ex}Trong các câu sau, có bao nhiêu câu là mệnh đề?
1. Ngôi nhà đẹp quá!
...
{D. $4$}
\loigiai{
Câu "Ngôi nhà đẹp quá!" là câu cảm thán, không phải là mệnh đề.\nCâu "Năm 1900 không phải là năm nhuận." là một mệnh đề đúng.\nCâu "Số 9 là số nguyên tố." là một mệnh đề sai.\nCâu "$x^3+1=0$" là mệnh đề chứa biến, không phải là mệnh đề.\nVậy có $2$ mệnh đề.\nChọn đáp án C.
}
\end{ex}
