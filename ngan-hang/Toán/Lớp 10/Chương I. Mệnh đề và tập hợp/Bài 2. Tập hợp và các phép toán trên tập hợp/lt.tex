...
\end{hoatdong}
\loigiai{
Để giải quyết bài toán này, chúng ta có thể sử dụng sơ đồ Venn hoặc công thức về số phần tử của hợp hai tập hợp.
\begin{enumerate}
    \item Gọi $A$ là tập hợp các bạn thi đấu bóng đá, $B$ là tập hợp các bạn thi đấu cầu lông.
    \item Số bạn tham gia bóng đá là $n(A) = 16$.
    \item Số bạn tham gia cầu lông là $n(B) = 11$.
    \item Số bạn tham gia ít nhất một trong hai môn (tức là tham gia bóng đá hoặc cầu lông hoặc cả hai) là $n(A \cup B) = 24$.
    \item Số bạn tham gia thi đấu cả hai môn (tức là thuộc cả tập $A$ và tập $B$) là $n(A \cap B)$.
    Theo công thức: $n(A \cup B) = n(A) + n(B) - n(A \cap B)$.
    Từ đó suy ra:
    \[
    \begin{aligned}
