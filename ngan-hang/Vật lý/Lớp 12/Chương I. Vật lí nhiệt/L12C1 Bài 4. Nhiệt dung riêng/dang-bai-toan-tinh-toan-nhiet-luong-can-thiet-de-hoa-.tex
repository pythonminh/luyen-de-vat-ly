...
\begin{tikzpicture}[>=stealth,scale=0.9]
    ...
    \draw[->] (0,0) -- (5,0) node[below] {$\tau(\mathrm{phút})$};
...
\choiceTF
{Tại điểm $A$, toàn bộ nước đá trong xô đã tan hết.}
{Trong $50$ phút đầu, hỗn hợp không hấp thụ nhiệt từ môi trường.}
{Khối lượng nước ban đầu trong xô xấp xỉ $8,76\,\mathrm{kg}$.}
{Khối lượng nước đá còn lại trong xô ở thời điểm $20$ phút xấp xỉ
$0,75\,\mathrm{kg}$.}
...
{Cần cung cấp $170\,\mathrm{kJ}$ để làm tan chảy hoàn toàn lượng nước đá ban đầu.}
{Khối lượng nước đá ban đầu là $0,20\,\mathrm{kg}$.}
{Khối lượng ca nhôm xấp xỉ $0,265\,\mathrm{kg}$.}
...
\begin{tikzpicture}[>=stealth,scale=0.9]
    ...
    \draw[->] (0,0) -- (6,0) node[below] {$\tau(\mathrm{phút})$};
...
từ lò nung.}
{Đoạn $CD$ ứng với giai đoạn khối kim loại ở thể lỏng.}
{Nhiệt dung riêng của khối kim loại xấp xỉ
$459,8\,\mathrm{J/(kg.K)}$.}
