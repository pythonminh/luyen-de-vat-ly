...
\begin{ex}
% ID: L12C1B6-14-TLN
% Mức: THMột thiết bị lấy khỏi phòng $900 \text{ kJ}$ nhờ $0,50 \text{ kg}$ môi chất bay hơi. Tính nhiệt hóa hơi riêng $L$ của môi chất theo đơn vị $10^5 \text{ J/kg}$, chỉ ghi số.
\shortans{18}
\loigiai{
...
\begin{ex}
% ID: L12C1B6-15-TLN
% Mức: THNước bay hơi $50 \text{ g}$ khỏi sân. Biết nhiệt hóa hơi riêng của nước là $L = 2,3 \cdot 10^6 \text{ J/kg}$. Nhiệt lượng mà nước đã lấy từ môi trường để bay hơi, tính theo kilojoule (kJ), là bao nhiêu?
\shortans{115}
\loigiai{
...
\begin{ex}
% ID: L12C1B6-16-TLN
% Mức: VDMột dàn lạnh làm bay hơi $0,20 \text{ kg}$ môi chất mỗi phút. Biết nhiệt hóa hơi riêng của môi chất là $L = 1,5 \cdot 10^5 \text{ J/kg}$. Tính nhiệt lượng mà dàn lạnh thu được mỗi phút theo kilojoule (kJ). Chỉ ghi giá trị số.
\shortans{30}
\loigiai{
...
\begin{ex}
% ID: L12C1B6-17-TLN
% Mức: VDHơi nước có khối lượng $0,10 \text{ kg}$ ở nhiệt độ $100 \text{ }^\circ\text{C}$ ngưng tụ hoàn toàn thành nước ở $100 \text{ }^\circ\text{C}$. Cho biết nhiệt hóa hơi riêng của nước là $L = 2,3 \cdot 10^6 \text{ J/kg}$. Tính nhiệt lượng tỏa ra trong quá trình ngưng tụ này theo kilojoule (kJ).
\shortans{230}
\loigiai{
...
\begin{ex}
% ID: L12C1B6-18-TLN
% Mức: VDCHơi nước ngưng tụ tỏa ra một nhiệt lượng là $460 \text{ kJ}$. Biết nhiệt hóa hơi riêng của nước là $L = 2,3 \cdot 10^6 \text{ J/kg}$. Khối lượng hơi nước đã ngưng tụ là bao nhiêu gam?
\shortans{200}
\loigiai{
