...
\dangbt{Thang nhiệt độ và nhiệt kế}
\begin{ex}Một học sinh tìm hiểu về việc hiệu chuẩn nhiệt kế và mối liên hệ giữa thang nhiệt độ Celsius ($t) $và thang nhiệt độ Kelvin ($T)$. Xét tính đúng/sai của các phát biểu sau:
\choiceTF
...
{Ta có thể dùng nhiệt kế rượu thông thường để đo nhiệt độ cực thấp gần độ không tuyệt đối ($0\ \mathrm{K}$) vì rượu có nhiệt độ đông đặc rất thấp.}
\loigiai{
a) Đúng. Theo thang nhiệt độ Kelvin, độ không tuyệt đối $0\ \mathrm{K}$ ứng với $-273{,}15\ ^\circ\mathrm{C}$.
b) Đúng. Độ chia trên hai thang đo là như nhau nên biến thiên nhiệt độ thỏa mãn $\Delta T=\Delta t=20\ \mathrm{K}$.
c) Sai. Ở áp suất tiêu chuẩn, nước sôi ở $100\ ^\circ\mathrm{C}$ chứ không phải $50\ ^\circ\mathrm{C}$.
d) Sai. Rượu bị đông đặc ở khoảng $-114{,}1\ ^\circ\mathrm{C}$ (khoảng $159\ \mathrm{K}) $nên không thể đo nhiệt độ gần $0\ \mathrm{K}$.
}
\end{ex}
