...
\dangbt{Thang nhiệt độ và nhiệt kế}
\begin{ex}
Một học sinh tiến hành tìm hiểu về việc hiệu chuẩn nhiệt kế và mối liên hệ giữa thang nhiệt độ Celsius (\\(t\\)) và thang nhiệt độ tuyệt đối Kelvin (\\(T\\)). Xét tính đúng/sai của các phát biểu sau:
\choiceTF
...
- Mệnh đề d) SAI, vì rượu hóa rắn ở \\(-114{,}1\ ^\circ\mathrm{C}\\) (\\(159\ \mathrm{K}\\)), hoàn toàn bị đông đặc thành thể rắn trước khi đạt tới gần \\(0\ \mathrm{K}\\) nên không thể đo được.
}
\end{ex}
