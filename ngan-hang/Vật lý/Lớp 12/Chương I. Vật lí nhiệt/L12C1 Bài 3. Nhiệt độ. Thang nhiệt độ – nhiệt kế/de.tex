...
\dangbt{Thang nhiệt độ và nhiệt kế}
\begin{ex}
Một nhiệt kế thủy ngân có thang chia độ Celsius bị lỗi kỹ thuật (các vạch chia đều nhau nhưng chỉ sai số chuẩn). Khi nhúng nhiệt kế này vào nước đá đang tan ở áp suất tiêu chuẩn, nó chỉ \\(-2\ ^\circ\mathrm{C}\\). Khi nhúng nó vào hơi nước đang sôi ở áp suất tiêu chuẩn, nó chỉ \\(103\ ^\circ\mathrm{C}\\).
\begin{enumerate}
    \item Lập công thức liên hệ giữa nhiệt độ thực tế \\(t_{\mathrm{thực}}\ (^\circ\mathrm{C})\\) và số chỉ trên nhiệt kế lỗi \\(t_{\mathrm{đo}}\ (^\circ\mathrm{C})\\).
...
\loigiai{
\begin{enumerate}
    \item Theo định nghĩa mốc chuẩn của thang Celsius:
    ...
    \\]
    \item Thay \\(t_{\mathrm{đo}} = 23\ ^\circ\mathrm{C}\\) vào công thức hiệu chuẩn vừa tìm được:
    \\[
