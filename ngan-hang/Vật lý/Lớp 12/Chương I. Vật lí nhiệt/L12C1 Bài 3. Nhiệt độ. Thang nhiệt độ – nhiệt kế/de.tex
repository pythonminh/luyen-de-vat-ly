...
\dangbt{Thang nhiệt độ và nhiệt kế}
\begin{ex}Khí nitrogen lỏng ở áp suất tiêu chuẩn sôi ở nhiệt độ $77\ \mathrm{K}$. Giá trị nhiệt độ sôi này tính theo thang Celsius bằng bao nhiêu $^\circ\mathrm{C}$?
\shortans{-196}
\loigiai{
Áp dụng công thức chuyển đổi từ nhiệt độ tuyệt đối Kelvin sang nhiệt độ Celsius:
$t\ (^\circ\mathrm{C}) = T\ (\mathrm{K}) - 273$
Thay giá trị $T = 77\ \mathrm{K}$ vào công thức, ta có:
$t\ (^\circ\mathrm{C}) = 77 - 273t\ (^\circ\mathrm{C}) = -196$
Vậy, nhiệt độ sôi của nitrogen lỏng là $-196\ ^\circ\mathrm{C}$.
}
\end{ex}
...
\dangbt{Thang nhiệt độ và nhiệt kế}
\begin{ex}Một nhiệt kế thủy ngân bị lỗi kỹ thuật có các vạch chia đều nhau nhưng chỉ sai số. Khi nhúng nhiệt kế vào nước đá đang tan ở áp suất tiêu chuẩn, nhiệt kế chỉ $-2\ ^\circ\mathrm{C}$. Khi nhúng vào hơi nước đang sôi ở áp suất tiêu chuẩn, nhiệt kế chỉ $103\ ^\circ\mathrm{C}$. Tìm nhiệt độ thực tế theo thang Celsius khi số chỉ đo được trên nhiệt kế bị lỗi này đúng bằng giá trị nhiệt độ thực tế đó.
\shortans{40}
\loigiai{
Gọi $x$ là nhiệt độ thực tế cần tìm (theo độ Celsius). Do số chỉ của nhiệt kế biến thiên tuyến tính theo nhiệt độ thực tế, ta có mối quan hệ:
$\dfrac{x - 0}{100 - 0} = \dfrac{x - (-2)}{103 - (-2)}\implies \dfrac{x}{100} = \dfrac{x + 2}{105}$
Nhân chéo hai vế, ta được:
$105x = 100(x + 2)105x = 100x + 200105x - 100x = 2005x = 200x = \dfrac{200}{5}x = 40$
Vậy, nhiệt độ thực tế là $40\ ^\circ\mathrm{C}$.
}
\end{ex}
