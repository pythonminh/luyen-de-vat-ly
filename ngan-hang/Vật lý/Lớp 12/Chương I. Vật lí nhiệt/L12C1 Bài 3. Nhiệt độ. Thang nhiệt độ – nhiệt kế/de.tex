...
\dangbt{Thang nhiệt độ và nhiệt kế}
\begin{ex}
Một nhiệt kế điện trở có điện trở biến thiên tuyến tính theo nhiệt độ. Tại nhiệt độ của nước đá đang tan (\\(0\ ^\circ\mathrm{C}\\)), điện trở của nhiệt kế là \\(100{,}0\ \Omega\\); tại nhiệt độ của hơi nước đang sôi (\\(100\ ^\circ\mathrm{C}\\)), điện trở của nhiệt kế là \\(138{,}5\ \Omega\\). Khi nhúng nhiệt kế vào một môi trường lỏng, điện trở đo được là \\(115{,}4\ \Omega\\). Nhiệt độ của môi trường lỏng này theo thang Celsius bằng bao nhiêu \\(^\circ\mathrm{C}\\)?
\shortans{40}
\loigiai{Hàm phụ thuộc tuyến tính của điện trở theo nhiệt độ có dạng \\(R(t) = a \cdot t + R_0\\).
Tại \\(t = 0\ ^\circ\mathrm{C} \implies R_0 = 100{,}0\ \Omega\\).
Tại \\(t = 100\ ^\circ\mathrm{C} \implies a = \dfrac{138{,}5 - 100{,}0}{100} = 0{,}385\ \Omega/^\circ\mathrm{C}\\).
Nhiệt độ của môi trường lỏng khi \\(R_t = 115{,}4\ \Omega\\) là:
