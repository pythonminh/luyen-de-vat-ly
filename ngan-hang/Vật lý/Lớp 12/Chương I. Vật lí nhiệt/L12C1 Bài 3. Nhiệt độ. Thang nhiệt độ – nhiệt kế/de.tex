...
\end{ex}
\dangbt{Thang nhiệt độ và nhiệt kế}
\begin{ex}Xét các phát biểu sau về các thang nhiệt độ và nguyên lý hoạt động của nhiệt kế:
\choiceTF
...
\loigiai{
a) ĐÚNG. Đây là định nghĩa chuẩn của thang nhiệt độ Celsius.
b) SAI. Độ lớn của một độ chia $1\ \mathrm{K}$ trong thang Kelvin bằng đúng độ lớn của một độ chia $1\ ^\circ\mathrm{C}$ trong thang Celsius, tức là $\Delta T = \Delta t$.
c) ĐÚNG. Nhiệt kế chất lỏng (thủy ngân, rượu) hoạt động dựa trên sự giãn nở vì nhiệt của chất lỏng trong ống mao dẫn.
d) SAI. Cặp nhiệt điện hoạt động dựa trên sự thay đổi suất điện động tiếp xúc, còn nhiệt kế điện trở dựa trên sự biến thiên điện trở theo nhiệt độ. Nhiệt kế hồng ngoại mới dựa trên sự bức xạ hồng ngoại.
}
\end{ex}
