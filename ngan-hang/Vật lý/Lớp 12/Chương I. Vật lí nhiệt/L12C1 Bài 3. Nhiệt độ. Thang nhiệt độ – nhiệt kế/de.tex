...
\end{ex}
\dangbt{Thang nhiệt độ và nhiệt kế}
\begin{ex}Khi nghiên cứu về các thang nhiệt độ và nguyên lý hoạt động của các loại nhiệt kế thông dụng, hãy xét tính đúng/sai của các phát biểu sau:
\choiceTF
...
Mệnh đề b) SAI. Độ lớn của một độ chia $1\ \mathrm{K}$ trong thang Kelvin bằng đúng độ lớn của một độ chia $1\ ^\circ\mathrm{C}$ trong thang Celsius, tức là $\Delta T = \Delta t$.
