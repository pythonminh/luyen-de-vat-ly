...
\begin{center}\includegraphics[width=0.55\linewidth]{images/w-e97e056419.png}\end{center}
\begin{center}\includegraphics[width=0.55\linewidth]{images/w-1d3887734b.png}\end{center}
\choice
{\True $212^\circ F$}
{$100^\circ F$}
{$32^\circ F$}
...
\begin{center}\includegraphics[width=0.55\linewidth]{images/w-a245344207.png}\end{center}
\begin{center}\includegraphics[width=0.55\linewidth]{images/w-c3f4eb2209.jpg}\end{center}
\choice
...
\begin{center}\includegraphics[width=0.55\linewidth]{images/w-26e93f628f.png}\end{center}
\choice
{Jun (J) .}
{Jun trên độ (J/ độ).}
...
\begin{center}\includegraphics[width=0.55\linewidth]{images/w-a26de0e3fe.png}\end{center}
\choice
{Đông đặc}
{Thăng hoa.}
{\True Hoá hơi.}
...
\begin{center}\includegraphics[width=0.55\linewidth]{images/w-31f1ed9758.png}\end{center}
\choice
...
\begin{center}\includegraphics[width=0.55\linewidth]{images/w-f842575d8f.png}\end{center}
\choice
{0,5 J.}
{2 J.}
{1,5 J.}
...
\dangbt{Chưa phân dạng}
\begin{ex}
Nhiệt lượng cần cung cấp cho 0,5 kg nước ở $20^\circ C$ đến khi nó sôi là bao nhiêu? Biết nhiệt dung của nước là $4180$ J/kg.K.
\begin{center}\includegraphics[width=0.55\linewidth]{images/w-1074b25331.png}\end{center}
\choice
{5.105 J.}
{3.105 J.}
{\True 2,09.105 J.}
{4,18.105 J.}
\loigiai{Nhiệt lượng cần cung cấp để nước tăng nhiệt độ từ $20^\circ C$ đến $100^\circ C$ (nhiệt độ sôi) là:
$Q = mc\Delta T = 0.5 \times 4180 \times (100 - 20) = 0.5 \times 4180 \times 80 = 209000$ J $= 2.09 \times 10^5$ J.}
\end{ex}
...
\begin{center}\includegraphics[width=0.55\linewidth]{images/w-413461af90.png}\end{center}
\choice
{$6,8.10^5$ J.}
{\True $7,636.10^5$ J.}
{$8,472.10^5$ J.}
