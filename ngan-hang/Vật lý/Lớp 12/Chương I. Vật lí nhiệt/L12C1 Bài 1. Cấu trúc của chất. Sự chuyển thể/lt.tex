...
% =========================
% Quỹ đạo ngẫu nhiên của hạt phấn
% =========================
\draw[
    orange!80!black,
    dashed,
...
% Mũi tên chỉ chuyển động tức thời
\draw[
    ->,
    ultra thick,
    orange!90!black
...
\node[
    ...
    at (3.5,-0.45)
    {Các phân tử nước chuyển động hỗn loạn\\
     va chạm làm hạt phấn chuyển động Brown};

\end{tikzpicture}%
}
\captionof{figure}{Mô hình chuyển động Brown của hạt phấn hoa trong nước}
\label{fig:chuyen-dong-brown}
\end{figure}
