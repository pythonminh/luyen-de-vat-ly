...
\dangbt{Phân loại chất rắn}
\begin{ex}
Thép và gang đều là hợp kim của sắt (\\(\mathrm{Fe}\\)) và cacbon (\\(\mathrm{C}\\)). Thép có hàm lượng \\(\mathrm{C}\\) từ \\(0{,}02\%\\) đến \\(2{,}14\%\\), còn gang có hàm lượng \\(\mathrm{C}\\) lớn hơn \\(2{,}14\%\\). Để tăng lượng cacbon khi nấu chảy thép phế liệu trong nồi nhằm chế tạo gang, người thợ thường bỏ thêm rơm (thân cây lúa đã phơi khô) vào nồi thép nóng chảy.
\begin{enumerate}
    \item Kim loại làm nồi nấu gang, thép nóng chảy phải có đặc điểm gì nổi bật?
    \item Hãy giải thích cách tăng tỉ lệ cacbon của người thợ bằng cách bỏ thêm rơm vào nồi.
\end{enumerate}
\loigiai{
\begin{enumerate}
    \item Kim loại làm nồi nấu gang, thép phải có nhiệt độ nóng chảy xác định cao hơn nhiều so với nhiệt độ nóng chảy của cả gang và thép (thường dùng các kim loại siêu chịu nhiệt như vônfram hoặc các loại gốm oxit chịu nhiệt đặc biệt) để nồi không bị nóng chảy hoặc bị hòa tan vào hợp kim trong lò luyện.
    \item Rơm phơi khô có thành phần cấu tạo chủ yếu là chất hữu cơ giàu cacbon (\\(\mathrm{C}\\)). Khi bỏ rơm vào nồi thép đang nóng chảy ở nhiệt độ rất cao, rơm bị phân hủy nhiệt trong điều kiện thiếu oxy (cháy âm ỉ) tạo ra muội than (cacbon nguyên chất). Cacbon này dễ dàng khuếch tán và hòa tan vào sắt nóng chảy làm tăng hàm lượng cacbon trong hợp kim sắt để tạo thành gang.
\end{enumerate}
}
