		...
		\begin{tikzpicture}[>=stealth, thick]
			...
			\begin{scope}[shift={(5.5,0)}]
				...
				\foreach \angle in {0, 45, 90, 135}{
					\draw[<->, dotted]
					({4.25+0.5*cos(\angle)},{1.25+0.5*sin(\angle)})
					-- ({4.25+0.5*cos(\angle+180)},{1.25+0.5*sin(\angle+180)});
				}
			\end{scope}
			...
			\begin{scope}[shift={(11,0)}]
				...
				\foreach \angle in {0, 45, 90, 135}{
					\draw[<->, dotted] 
					({4+0.5*cos(\angle)},{2+0.5*sin(\angle)}) -- ({4+0.5*cos(\angle+180)},{2+0.5*sin(\angle+180)});
					\draw[<->, dotted] 
					({4.25+0.5*cos(\angle)},{0.75+0.5*sin(\angle)}) -- ({4.25+0.5*cos(\angle+180)},{0.75+0.5*sin(\angle+180)});
				}
