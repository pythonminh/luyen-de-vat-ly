...
\begin{hoatdong}
\chuy{Bài toán nóng chảy một phần và đông đặc:}
Xét một khối nước đá ở nhiệt độ dưới $0^\circ$C được đặt vào một bình chứa nước ở nhiệt độ trên $0^\circ$C.
\begin{itemize}
    \item \textbf{Phát biểu 1:} Nếu nhiệt lượng do nước tỏa ra không đủ để làm nước đá tăng nhiệt độ đến $0^\circ$C, thì nước đá sẽ không nóng chảy và nhiệt độ cuối cùng của hệ sẽ nhỏ hơn $0^\circ$C.
    \item \textbf{Phát biểu 2:} Nếu nhiệt lượng do nước tỏa ra đủ để làm nước đá tăng nhiệt độ đến $0^\circ$C và nóng chảy một phần, thì nhiệt độ cuối cùng của hệ sẽ là $0^\circ$C.
    \item \textbf{Phát biểu 3:} Nếu nhiệt lượng do nước tỏa ra đủ để làm nước đá nóng chảy hoàn toàn và tiếp tục tăng nhiệt độ, thì nhiệt độ cuối cùng của hệ sẽ lớn hơn $0^\circ$C.
\end{itemize}
Các phát biểu trên đều đúng và mô tả các trường hợp có thể xảy ra trong bài toán nóng chảy và đông đặc. Để giải quyết các bài toán này, cần xác định rõ các giai đoạn chuyển nhiệt và trạng thái cuối cùng của hệ.
\end{hoatdong}
