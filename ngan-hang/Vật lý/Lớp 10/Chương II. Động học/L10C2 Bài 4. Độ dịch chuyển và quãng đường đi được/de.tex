...
% Mức: TH
\dangbt{Phân biệt quãng đường và độ dịch chuyển trong chuyển động thẳng}
\begin{ex}Chọn phát biểu sai khi nói về độ dịch chuyển:
\choice
...
\loigiai{
Nếu vật đổi chiều, quãng đường luôn lớn hơn độ lớn của độ dịch chuyển $\Rightarrow D$ là sai.
}
\end{ex}
...
{\True Không thể có độ lớn bằng 0.}
{Có thể có độ lớn bằng 0.}
\loigiai{Quãng đường là độ dài quỹ đạo mà vật đi được, luôn có giá trị dương và không thể bằng 0 (trừ khi vật đứng yên). Độ dịch chuyển là một vectơ, có thể có độ lớn bằng 0 nếu vật quay về vị trí ban đầu.}
\end{ex}
...
\loigiai{Độ lớn của độ dịch chuyển và quãng đường đi được của vật bằng nhau khi vật chuyển động thẳng và không đổi chiều. Trong các trường hợp còn lại, quãng đường sẽ lớn hơn độ lớn của độ dịch chuyển.}
\end{ex}
...
{\True Khi vật chuyển động thẳng không đổi chiều, độ lớn của véc tơ độ dịch chuyển bằng quãng đường đi được.}
{Vận tốc tức thời cho ta biết chiều chuyển động nên luôn có giá trị dương.}
\loigiai{A sai vì vectơ độ dịch chuyển chỉ phụ thuộc vào vị trí đầu và cuối, không thay đổi phương liên tục. B sai vì độ lớn độ dịch chuyển chỉ bằng quãng đường khi vật chuyển động thẳng không đổi chiều. D sai vì vận tốc tức thời có thể âm, dương hoặc bằng 0.}
\end{ex}
...
{Độ dịch chuyển có thể có giá trị âm, dương, hoặc bằng không.}
\loigiai{Phát biểu B sai. Độ lớn của vectơ độ dịch chuyển chỉ bằng quãng đường đi được khi vật chuyển động thẳng và không đổi chiều. Trong các trường hợp khác, quãng đường thường lớn hơn độ lớn độ dịch chuyển.}
\end{ex}
...
{\True chuyển động thẳng và không đổi chiều chuyển động.}
{đi từ điểm A đến điểm B, sau đó đến điểm C, rồi quay về A.}
{đi từ điểm A đến điểm B, sau đó đến điểm C, rồi quay về}
\loigiai{Quãng đường và độ lớn của độ dịch chuyển có cùng độ lớn khi vật chuyển động thẳng và không đổi chiều. Trong các trường hợp còn lại, quãng đường sẽ lớn hơn độ lớn của độ dịch chuyển (trừ trường hợp quay về vị trí ban đầu thì độ dịch chuyển bằng 0).}
\end{ex}
...
{AB/2.}
{AB/4.}
\loigiai{Độ dịch chuyển là vectơ nối vị trí đầu và vị trí cuối. Vì xe xuất phát từ A và quay trở về A, nên vị trí đầu và vị trí cuối trùng nhau. Do đó, độ dịch chuyển của xe bằng 0.}
\end{ex}

\dangbt{Phân biệt quãng đường và độ dịch chuyển trong chuyển động thẳng}
\begin{ex}
Một ô tô chuyển động trên đường thẳng. Tại thời điểm t1, ô tô ở cách vị trí xuất phát 5 km. Tại thời điểm t2, ô tô cách vị trí xuất phát 12 km. Từ thời điểm t1 đến thời điểm t2, độ dịch chuyển của ô tô bằng
\choice
{5 km.}
{0.}
{17 km}
{\True 7 km}
\loigiai{Độ dịch chuyển là sự thay đổi vị trí. Nếu ô tô chuyển động thẳng theo một chiều, độ dịch chuyển là $12 - 5 = 7$ km. Nếu ô tô đổi chiều, độ dịch chuyển vẫn là $12 - 5 = 7$ km hoặc $5 - 12 = -7$ km tùy thuộc vào hướng, nhưng độ lớn là 7 km.}
\end{ex}
...
{\True 160 km.}
{480 km}
\loigiai{Hình vẽ không được cung cấp, nhưng nếu vật bắt đầu từ O và chuyển động thẳng đều với vận tốc 40 km/h, thì sau 12h, vị trí của vật cách O là $40 \times 12 = 480$ km. Tuy nhiên, nếu đề bài có ý đồ khác (ví dụ, vật đã đi được một khoảng thời gian trước đó), cần có thêm thông tin. Với các phương án cho, có thể hiểu là vật bắt đầu từ một vị trí nào đó và sau 12h, vị trí của vật là 160 km nếu nó đã đi được 4 giờ (ví dụ, từ 8h đến 12h). Giả sử vật bắt đầu từ 8h và đến 12h là 4h chuyển động. $4 \times 40 = 160$ km.}
\end{ex}
...
\loigiai{Phát biểu D sai. Khi vật chuyển động thẳng có đổi chiều, quãng đường đi được sẽ lớn hơn độ lớn của độ dịch chuyển.}
\end{ex}
...
{\True Trong chuyển động thẳng độ dịch chuyển bằng độ biến thiên tọa độ.}
{Độ dịch chuyển có giá trị luôn dương.}
\loigiai{A sai vì vectơ độ dịch chuyển chỉ phụ thuộc vào vị trí đầu và cuối. B sai vì độ lớn độ dịch chuyển chỉ bằng quãng đường khi vật chuyển động thẳng không đổi chiều. D sai vì độ dịch chuyển có thể âm, dương hoặc bằng 0.}
\end{ex}
...
{\True Vật đi từ A đến B, từ B đến C rồi từ C về A thì có độ dịch chuyển bằng AB + BC + CA.}
{Vật đi từ A đến B, từ B đến C rồi từ C về A thì có độ dịch chuyển bằng 0.}
{Độ dịch chuyển có thể dương, âm hoặc bằng 0.}
\loigiai{Phát biểu B sai. Nếu vật đi từ A đến B, từ B đến C rồi từ C về A, vị trí cuối cùng trùng với vị trí ban đầu (A). Do đó, độ dịch chuyển của vật bằng 0.}
\end{ex}
...
{2 m, 2 m.}
{8m, - 8m.}
\loigiai{Hình vẽ không được cung cấp, nhưng dựa vào các phương án, ta có thể suy luận:
Giả sử O là gốc tọa độ. A ở vị trí 5m (hoặc 6m) và B ở vị trí -2m (hoặc -3m).
Nếu vật đi từ O đến A (giả sử A là 5m), sau đó từ A về B (giả sử B là -2m).
Quãng đường: $s = OA + AB = 5 + |(-2) - 5| = 5 + 7 = 12$m. (Không khớp với đáp án)
Nếu vật đi từ O đến A (giả sử A là 5m), sau đó từ A về B (giả sử B là -3m).
Quãng đường: $s = OA + AB = 5 + |(-3) - 5| = 5 + 8 = 13$m. (Không khớp với đáp án)

Xét đáp án B: Quãng đường 8m, độ dịch chuyển -2m.
Điều này có nghĩa là vật đi từ O đến một điểm nào đó (ví dụ 5m), sau đó quay lại điểm B (-2m).
Độ dịch chuyển $d = x_B - x_O = -2 - 0 = -2$m.
Quãng đường $s = |x_A - x_O| + |x_B - x_A|$.
Nếu A là 5m, B là -2m, thì $s = |5-0| + |-2-5| = 5 + 7 = 12$m.
Nếu A là 3m, B là -2m, thì $s = |3-0| + |-2-3| = 3 + 5 = 8$m.
Vậy, vật đi từ O đến A (tọa độ 3m), sau đó quay về B (tọa độ -2m).
Quãng đường: $s = OA + AB = 3 + |(-2) - 3| = 3 + 5 = 8$m.
Độ dịch chuyển: $d = x_B - x_O = -2 - 0 = -2$m.
Đáp án B là phù hợp nhất với giả định này.}
\end{ex}
...
{5 km.}
{10 km.}
\loigiai{Quãng đường đi được là tổng độ dài các đoạn đường mà ô tô đã đi.
Quãng đường $s = 6 \text{ km} + 4 \text{ km} + 3 \text{ km} = 13 \text{ km}$.}
\end{ex}
...
{\True Vật 2 đi 200 m theo hướng 450 Đông – Bắc.}
{Vật 3 đi 30 m theo hướng Đông.}
{Vật 4 đi 100 m theo hướng Đông.}
\loigiai{Hình vẽ không được cung cấp. Tuy nhiên, dựa vào các phương án, ta có thể suy luận:
- Vật 1: Nếu đi 200m theo hướng Nam, thì vectơ dịch chuyển hướng xuống.
- Vật 2: Nếu đi 200m theo hướng 45 độ Đông - Bắc, thì vectơ dịch chuyển có độ lớn 200m và tạo góc 45 độ với trục Đông và Bắc.
- Vật 3: Nếu đi 30m theo hướng Đông, thì vectơ dịch chuyển hướng sang phải, độ lớn 30m.
- Vật 4: Nếu đi 100m theo hướng Đông, thì vectơ dịch chuyển hướng sang phải, độ lớn 100m.

Giả sử hình vẽ có các vectơ dịch chuyển tương ứng. Phương án B là một mô tả cụ thể về độ dịch chuyển (độ lớn và hướng). Nếu hình vẽ thể hiện một vectơ có độ lớn 200m và hướng 45 độ Đông - Bắc, thì B là đúng.}
\end{ex}
...
\loigiai{Hình vẽ không được cung cấp. Tuy nhiên, dựa vào các phương án:
- Người thứ nhất đi từ A đến B rồi đến C. Người thứ hai đi thẳng từ A đến C.
- Độ dịch chuyển là vectơ nối vị trí đầu và vị trí cuối. Cả hai người đều đi từ A đến C, nên độ dịch chuyển của họ là như nhau (vectơ $\vec{AC}$). Vậy B đúng.
- Người thứ nhất đi theo đường gấp khúc A-B-C. Quãng đường đi được là $AB + BC$. Độ dịch chuyển là độ lớn của vectơ $\vec{AC}$. Nếu A, B, C không thẳng hàng, thì $AB + BC > AC$. Do đó, quãng đường và độ dịch chuyển của người thứ nhất không bằng nhau. Vậy C sai.
- Nếu AB = 4 km, BC = 4 km và góc ABC là 90 độ (tam giác vuông cân), thì $AC = \sqrt{4^2 + 4^2} = \sqrt{32} \approx 5.66$ km. Quãng đường người thứ nhất đi là $4+4=8$ km. Độ dịch chuyển là 5.66 km.
- Nếu người thứ nhất đi 8 km (A), và độ dịch chuyển là 5.7 km, hướng 45 độ Đông - Bắc (D), thì điều này có thể xảy ra nếu A-B-C tạo thành một tam giác vuông cân.
- Phát biểu C là sai vì người thứ nhất đi đường gấp khúc, quãng đường sẽ lớn hơn độ lớn độ dịch chuyển.}
\end{ex}
...
{100 km.}
{35,35 km.}
\loigiai{Gọi $\vec{d_1}$ là độ dịch chuyển ngang sông (50 m), $\vec{d_2}$ là độ dịch chuyển xuôi dòng (50 m). Hai vectơ này vuông góc với nhau.
Độ dịch chuyển tổng hợp $\vec{d}$ có độ lớn là $d = \sqrt{d_1^2 + d_2^2} = \sqrt{50^2 + 50^2} = \sqrt{2 \times 50^2} = 50\sqrt{2} \approx 70.71$ m.
Lưu ý đơn vị trong đáp án là km, có thể là lỗi đánh máy. Nếu là 70.7 m thì đáp án A là đúng.}
\end{ex}

\dangbt{Phân biệt quãng đường và độ dịch chuyển trong chuyển động thẳng}
\begin{ex}
Khi so sánh quãng đường và độ dịch chuyển, phát biểu nào sau đây là đúng?
\choice
{Véc tơ độ dịch chuyển thay đổi phương liên tục khi vật chuyển động.}
{Véc tơ độ dịch chuyển có độ lớn luôn bằng quãng đường đi được của chất điểm.}
{\True Khi vật chuyển động thẳng không đổi chiều, độ lớn của véc tơ độ dịch chuyển bằng quãng đường đi được.}
{Quãng đường và độ dịch chuyển luôn có giá trị đương.}
\loigiai{A sai vì vectơ độ dịch chuyển chỉ phụ thuộc vào vị trí đầu và cuối. B sai vì độ lớn độ dịch chuyển chỉ bằng quãng đường khi vật chuyển động thẳng không đổi chiều. D sai vì độ dịch chuyển có thể âm hoặc bằng 0.}
\end{ex}
...
{Khi vật đi từ điểm A đến điểm B, sau đó đến điểm C, rồi quay về A thì độ dịch chuyển của vật có độ lớn bằng 0.}
{Độ dịch chuyển có thể có giá trị âm, dương, hoặc bằng không.}
\loigiai{Phát biểu B chưa chính xác. Độ lớn của vectơ độ dịch chuyển chỉ bằng quãng đường đi được khi vật chuyển động thẳng và không đổi chiều. Trong các trường hợp khác, quãng đường thường lớn hơn độ lớn độ dịch chuyển.}
\end{ex}
...
{\True vật chuyển động theo quỹ đạo thẳng và không đổi chiều.}
\loigiai{Quãng đường và độ dịch chuyển của một vật chuyển động có cùng độ lớn khi vật chuyển động thẳng và không đổi chiều. Các phương án B và C là các trường hợp riêng của chuyển động thẳng không đổi chiều, nhưng phương án tổng quát nhất và chính xác nhất là "vật chuyển động theo quỹ đạo thẳng và không đổi chiều".}
\end{ex}
...
\loigiai{Quãng đường là tổng độ dài quỹ đạo, luôn không âm. Độ lớn của độ dịch chuyển là khoảng cách giữa điểm đầu và điểm cuối. Theo bất đẳng thức tam giác, tổng độ dài các cạnh của một đường gấp khúc luôn lớn hơn hoặc bằng độ dài đoạn thẳng nối điểm đầu và điểm cuối. Do đó, quãng đường luôn lớn hơn hoặc bằng độ lớn của độ dịch chuyển.}
\end{ex}
...
\choice
{\True Con tàu đã đi 200 km về phía đông nam.}
...
\loigiai{Độ dịch chuyển là một đại lượng vectơ, cần có cả độ lớn và hướng. Phát biểu A "Con tàu đã đi 200 km về phía đông nam" cung cấp cả độ lớn (200 km) và hướng (đông nam), do đó đây là phát biểu nói về độ dịch chuyển. Các phát biểu còn lại chỉ nêu độ lớn và điểm đến, nhưng không rõ ràng về hướng cụ thể của vectơ dịch chuyển.}
\end{ex}
...
{\True Khi đi từ nhà đến trường sau đó quay về siêu thị quãng đường bằng 1200m.}
...
\loigiai{Hình vẽ không được cung cấp. Tuy nhiên, dựa vào các phương án:
Giả sử: Nhà ở 0m, Trường ở 1000m, Siêu thị ở 200m.
A. Khi đi từ nhà đến trường: quãng đường là 1000m (không thể âm). A sai.
B. Khi đi từ nhà đến trường (1000m) sau đó quay về siêu thị (200m):
Quãng đường = (Nhà -> Trường) + (Trường -> Siêu thị) = $1000 + |200 - 1000| = 1000 + 800 = 1800$m.
Nếu siêu thị ở -200m: Quãng đường = $1000 + |-200 - 1000| = 1000 + 1200 = 2200$m.
Nếu siêu thị ở 800m: Quãng đường = $1000 + |800 - 1000| = 1000 + 200 = 1200$m. Vậy B đúng với giả định này.
C. Khi đi từ nhà đến trường: độ dịch chuyển là $1000 - 0 = 1000$m (không phải -1000m nếu trường ở phía dương). C sai.
D. Khi đi từ nhà đến trường sau đó quay về siêu thị: độ dịch chuyển là $x_{siêu thị} - x_{nhà}$. Nếu siêu thị ở 800m, độ dịch chuyển là 800m. Nếu siêu thị ở -8000m, thì độ dịch chuyển là -8000m. Nhưng đây là một con số rất lớn so với các con số khác, có thể là lỗi đánh máy hoặc không phù hợp với ngữ cảnh.

Với giả định siêu thị ở 800m, thì B là đúng.}
\end{ex}
\dangbt{Phân biệt quãng đường và độ dịch chuyển trong chuyển động thẳng}
\begin{ex}
Xét quãng đường AB dài 1000 m với A là vị trí nhà của em và B là vị trí của bưu điện như hình vẽ. Tiệm tạp hóa nằm tại vị trí C là trung điểm của AB. Nếu chọn nhà em làm gốc tọa độ và chiều dương hướng từ nhà em đến bưu điện.
\choiceTF
{\True Quãng đường đi từ nhà đến bưu điện rồi trở lại tiệm tạp hóa là 1500 m.}
{Độ dịch chuyển khi đi từ nhà đến bưu điện rồi quay trở về nhà là 2000 m.}
{\True Quãng đường đi từ tiệm tạp hóa đến bưu điện là 500 m.}
{Độ dịch chuyển khi đi từ tiệm tạp hóa đến bưu điện rồi quay về nhà là 500 m.}
\loigiai{a đúng. Khi đi từ nhà đến bưu điện rồi trở lại tiệm tạp hóa đi được quãng đường $s = AB + BC = 1000 + 500 = 1500$ m.
b sai. Độ dịch chuyển khi đi từ nhà đến bưu điện rồi quay trở về nhà là $d = 0$ m.
c đúng. Quãng đường đi từ tiệm tạp hóa đến bưu điện là $s = CB = 500$ m.
d sai. Độ dịch chuyển khi đi từ tiệm tạp hóa đến bưu điện rồi quay trở về nhà là $d = CA = 500$ m.}
\end{ex}

\dangbt{Phân biệt quãng đường và độ dịch chuyển trong chuyển động thẳng}
\begin{ex}
Một vận động viên chạy từ một siêu thị (A) đến cổng Sân Vận Động (D) theo hai quỹ đạo khác nhau.
\choiceTF
{\True Người này đi từ siêu thị đến đường Điện Biên Phủ rồi đi hết đường Lê Lợi đi được quãng đường $s = AB + BC = 1500 + 1000 = 2500$ m.}
{\True Độ dịch chuyển của người đó khi đi từ siêu thị theo con đường Điện Biên Phủ - Lê Lợi – Văn Cao đến sân vận động bằng với độ dịch chuyển của người đó khi đi đến sân vận động theo đường Lê Duẩn.}
{\True Độ dịch chuyển của vận động viên đi từ siêu thị đến Lê Duẩn rồi đi hết đường là Văn Cao là AC.}
{\True Độ dịch chuyển của vận động viên đi từ siêu thị đến sân vận động rồi về lại siêu thị bằng 0.}
\loigiai{a đúng. Người này đi từ siêu thị đến đường Điện Biên Phủ rồi đi hết đường Lê Lợi đi được quãng đường $s = AB + BC = 1500 + 1000 = 2500$ m.
b đúng. Độ dịch chuyển đến sân vận động trong hai tuyến đường là bằng nhau vì điểm đầu và điểm cuối của hai tuyến đường là như nhau.
c đúng. Độ dịch chuyển của vận động viên đi từ siêu thị đến Lê Duẩn rồi đi hết đường là Văn Cao là AC.
d đúng. Độ dịch chuyển của vận động viên đi từ siêu thị đến sân vận động rồi về lại siêu thị là $d = 0$ vì điểm đầu và điểm cuối trùng nhau.}
\end{ex}
...
\choiceTF
{Quãng đường đi từ siêu thị đến bưu điện của xe máy lớn hơn của ô tô.}
{Độ dịch chuyển của người đi bộ nhỏ hơn độ dịch chuyển của người đi xe máy.}
{Quãng đường đi từ siêu thị đến bưu điện của ba người là như nhau.}
{\True Độ dịch chuyển của ba người là bằng nhau khi đi từ siêu thị đến bưu điện.}
\loigiai{a sai. Quãng đường đi từ siêu thị đến bưu điện của xe máy nhỏ hơn ô tô.
b sai. Độ dịch chuyển của 3 người là như nhau.
c sai. Quãng đường đi từ siêu thị đến bưu điện của ba người là khác nhau.
d đúng. Độ dịch chuyển của 3 người là như nhau vì điểm đầu và điểm cuối của ba người là như nhau.}
\end{ex}

\dangbt{Phân biệt quãng đường và độ dịch chuyển trong chuyển động thẳng}
\begin{ex}
Bạn A đi xe đạp từ nhà qua trạm xăng, tới siêu thị mua đồ rồi quay về nhà cất đồ, sau đó đi xe đến trường như hình dưới đây. Chọn hệ tọa độ có gốc là vị trí nhà bạn A, trục Ox trùng với đường đi từ nhà bạn A tới trường.
\choiceTF
{\True Quãng đường đi từ trạm xăng đến siêu thị mua đồ rồi về nhà cất đồ là 1200 m.}
{Độ dịch chuyển của bạn A đi từ nhà đến siêu thị rồi quay về nhà cất đồ là 1600 m.}
{\True Quãng đường của bạn A đi được trên cả chuyến đi là 2800 m.}
{Độ dịch chuyển của bạn A đi được trên cả chuyến là 2800 m.}
\loigiai{a đúng. Quãng đường đi từ trạm xăng đến siêu thị mua đồ rồi về nhà cất đồ là $s = 400 + 800 = 1200$ m.
b sai. Độ dịch chuyển của bạn A đi từ nhà đến siêu thị rồi quay về nhà cất đồ là $d = 0$.
c đúng. Quãng đường của bạn A đi được trên cả chuyến đi là $s = 2 \times 800 + 1200 = 2800$ m.
d sai. Độ dịch chuyển của bạn A đi được trên cả chuyến là $d = 1200$ m.}
\end{ex}

\dangbt{Phân biệt quãng đường và độ dịch chuyển trong chuyển động thẳng}
\begin{ex}
Một ô tô chuyển động trên đường thẳng. Tại thời điểm $t_1$, ô tô ở cách vị trí xuất phát 5 km. Tại thời điểm $t_2$, ô tô ở cách vị trí xuất phát 12 km. Từ $t_1$ đến $t_2$, độ dịch chuyển của ô tô đã thay đổi một đoạn bằng bao nhiêu?
\choiceTF
{\True Tại thời điểm $t_1$, độ dịch chuyển của ô tô là 5 km.}
{Từ lúc bắt đầu xuất phát đến thời điểm $t_2$ ô tô đi được 7 km.}
{Quãng đường đi từ thời điểm $t_1$ đến thời điểm $t_2$ là 12 km.}
{\True Độ dịch chuyển của ô tô đi từ thời điểm $t_1$ đến thời điểm $t_2$ là 7 km.}
\loigiai{a đúng. Tại thời điểm $t_1$, độ dịch chuyển là 5 km.
b sai. Từ thời điểm bắt đầu đến thời điểm $t_2$ quãng đường đi được là 12 km.
c sai. Quãng đường đi được từ thời điểm $t_1$ đến thời điểm $t_2$ là 7 km.
d đúng. Độ dịch chuyển của ô tô đi từ thời điểm $t_1$ đến thời điểm $t_2$ là $12 - 5 = 7$ km.}
\end{ex}

\dangbt{Phân biệt quãng đường và độ dịch chuyển trong chuyển động thẳng}
\begin{ex}
Hai anh em bơi trong bể bơi thiếu niên có chiều dài 20 m. Hai anh em xuất phát từ đầu bể bơi đến cuối bể bơi thì người em dừng lại nghỉ, còn người anh quay lại bơi tiếp về đầu bể mới nghỉ.
\choiceTF
{\True Quãng đường bơi được của người em là 20 m.}
{Độ dịch chuyển của người em là 0 m.}
{Quãng đường bơi được của người anh là 20 m.}
{\True Độ dịch chuyển của người anh là 0.}
\loigiai{a đúng. Quãng đường bơi được của người em $s_{em} = 20$ m.
b sai. Độ dịch chuyển của người em $d_{em} = s_{em} = 20$ m.
c sai. Quãng đường bơi được của người anh $s_{anh} = 20 + 20 = 40$ m.
d đúng. Độ dịch chuyển của người anh $d_{anh} = 0$ vì điểm đầu và điểm cuối trùng nhau.}
\end{ex}

\dangbt{Tổng hợp độ dịch chuyển bằng vectơ trong mặt phẳng}
\begin{ex}
Một người đi xe máy đi thẳng 6 km theo hướng Tây trong thời gian 9 phút sau đó rẽ phải và đi thẳng theo hướng Bắc 8 km trong thời gian 11 phút.
\choiceTF
{\True Độ dịch chuyển của xe đi theo hướng Tây – Bắc.}
{\True Quãng đường xe đi được là 14 km.}
{Độ dịch chuyển của xe đi được là 14 km.}
{\True Độ dịch chuyển của xe khi đi rồi trở về vị trí ban đầu là 0.}
\loigiai{a đúng. Độ dịch chuyển của xe đi theo hướng Tây – Bắc.
b đúng. Quãng đường đi được $s = s_1 + s_2 = 6 + 8 = 14$ km.
c sai. Độ dịch chuyển của xe đi được $d = \sqrt{6^2 + 8^2} = 10$ km.
d đúng. Độ dịch chuyển của xe đi được rồi trở lại vị trí ban đầu là $d = 0$.}
\end{ex}
...
\choiceTF
{\True Xe đi được 15 km trong 15 phút khi đi về phía Bắc.}
{\True Quãng đường xe đi được là 17,2 km.}
{Độ dịch chuyển mà người đó đi được là 17,2 km.}
{\True Độ dịch chuyển người đó đi và về là 0.}
\loigiai{a đúng. Quãng đường người đó đi trong 15 phút là $s_2 = v_2 t_2 = 60 \times (15/60) = 15$ km.
b đúng. Quãng đường mà người đó đi được là $s = s_1 + s_2 = 2,2 + 15 = 17,2$ km.
c sai. Độ dịch chuyển của người đó là $d = \sqrt{s_1^2 + s_2^2} = \sqrt{2,2^2 + 15^2} \approx 15,16$ km.
d đúng. Độ dịch chuyển người đó đi và về là $d = 0$.}
\end{ex}
...
\choiceTF
{\True Quãng đường người đó đi được là 26 km.}
{Độ dịch chuyển của người đó đi được là 26 km.}
{Hướng dịch chuyển của người đó là 90 độ.}
{\True Người này dịch chuyển theo hướng Đông – Bắc.}
\loigiai{a đúng. Quãng đường đi được $s = 6 + 20 = 26$ km.
b sai. Độ dịch chuyển $d = \sqrt{6^2 + 20^2} = \sqrt{36 + 400} = \sqrt{436} \approx 20,88$ km.
c sai. Hướng dịch chuyển của người đó là $\tan \alpha = 20/6 \approx 3,33 \Rightarrow \alpha \approx 73,3$ độ so với hướng Đông.
d đúng. Người này dịch chuyển theo hướng Đông – Bắc.}
\end{ex}
\dangbt{Phân biệt quãng đường và độ dịch chuyển trong chuyển động thẳng}
...
{Độ dịch chuyển được biểu diễn bằng một mũi tên nối vị trí đầu và vị trí cuối của chuyển động, có độ lớn chính bằng khoảng cách giữa vị trí đầu và vị trí cuối. Kí hiệu là $\vec{d}$.}
{\True Khi vật chuyển động thẳng, có đổi chiều thì độ lớn của độ dịch chuyển và quãng đường đi được bằng nhau (d = s).}
\loigiai{Khi vật chuyển động thẳng có đổi chiều, quãng đường đi được sẽ lớn hơn độ lớn của độ dịch chuyển.}
\end{ex}
...
{Độ dịch chuyển khi đi từ tiệm tạp hóa đến bưu điện rồi quay về nhà là 500 m.}
\loigiai{a đúng. Khi đi từ nhà đến bưu điện rồi trở lại tiệm tạp hóa đi được quãng đường $s = AB + BC = 1000 + 500 = 1500$ m.
b sai. Độ dịch chuyển khi đi từ nhà đến bưu điện rồi quay trở về nhà là $d = 0$.
c đúng. Quãng đường đi từ tiệm tạp hóa đến bưu điện là $s = CB = 500$ m.
d sai. Độ dịch chuyển khi đi từ tiệm tạp hóa đến bưu điện rồi quay trở về nhà là $d = CA = 500$ m.}
\end{ex}
...
\dangbt{Phân biệt quãng đường và độ dịch chuyển trong chuyển động thẳng}
\begin{ex}
Một vận động viên chạy từ một siêu thị (A) đến cổng Sân Vận Động (D) theo hai quỹ đạo khác nhau. Hãy xác định độ dịch chuyển và quãng đường chạy được của người vận động viên trong 2 trường hợp trên.
\choiceTF
{\True Người này đi từ siêu thị đến đường Điện Biên Phủ rồi đi hết đường Lê Lợi đi được quãng đường $s = AB + BC = 1000 + 500 = 1500$ m.}
{\True Độ dịch chuyển của người đó khi đi từ siêu thị theo con đường Điện Biên Phủ - Lê Lợi – Văn Cao đến sân vận động bằng với độ dịch chuyển của người đó khi đi đến sân vận động theo đường Lê Duẩn.}
{\True Độ dịch chuyển của vận động viên đi từ siêu thị đến Lê Duẩn rồi đi hết đường là Văn Cao là AC.}
{\True Độ dịch chuyển của vận động viên đi từ siêu thị đến sân vận động rồi về lại siêu thị bằng 0.}
\loigiai{a đúng. Người này đi từ siêu thị đến đường Điện Biên Phủ rồi đi hết đường Lê Lợi đi được quãng đường $s = AB + BC$.
b đúng. Độ dịch chuyển đến sân vận động trong hai tuyến đường là bằng nhau vì điểm đầu và điểm cuối trùng nhau.
c đúng. Độ dịch chuyển của vận động viên đi từ siêu thị đến Lê Duẩn rồi đi hết đường là Văn Cao là AC.
d đúng. Độ dịch chuyển của vận động viên đi từ siêu thị đến sân vận động rồi về lại siêu thị là $d = 0$.}
\end{ex}
...
{Quãng đường đi từ siêu thị đến bưu điện của ba người là như nhau.}
{\True Độ dịch chuyển của ba người là bằng nhau khi đi từ siêu thị đến bưu điện.}
\loigiai{a sai. Quãng đường đi từ siêu thị đến bưu điện của xe máy nhỏ hơn của ô tô.
b sai. Độ dịch chuyển của 3 người là như nhau.
c sai. Quãng đường đi từ siêu thị đến bưu điện của ba người là khác nhau.
d đúng. Độ dịch chuyển của 3 người là như nhau vì điểm đầu và điểm cuối trùng nhau.}
\end{ex}
...
{\True Độ dịch chuyển của ô tô đi từ thời điểm $t_1$ đến thời điểm $t_2$ là 7 km.}
\loigiai{a đúng. Tại thời điểm $t_1$, độ dịch chuyển là 5 km.
b sai. Từ thời điểm bắt đầu đến thời điểm $t_2$ quãng đường đi được là 12 km (nếu chuyển động thẳng không đổi chiều).
c sai. Quãng đường đi được từ thời điểm $t_1$ đến thời điểm $t_2$ là 7 km (nếu chuyển động thẳng không đổi chiều).
d đúng. Độ dịch chuyển của ô tô đi từ thời điểm $t_1$ đến thời điểm $t_2$ là $12 - 5 = 7$ km.}
\end{ex}
...
{Quãng đường bơi được của người anh là 20 m.}
{\True Độ dịch chuyển của người anh là 0.}
\loigiai{a đúng. Quãng đường bơi được của người em là $s_{em} = 20$ m.
b sai. Độ dịch chuyển của người em là $d_{em} = 20$ m.
c sai. Quãng đường bơi được của người anh là $s_{anh} = 20 + 20 = 40$ m.
d đúng. Độ dịch chuyển của người anh là $d_{anh} = 0$ vì điểm đầu và điểm cuối trùng nhau.}
\end{ex}
...
\loigiai{a đúng. Độ dịch chuyển của xe đi theo hướng Tây – Bắc.
b đúng. Quãng đường đi được $s = s_1 + s_2 = 6 + 8 = 14$ km.
c sai. Độ dịch chuyển của xe đi được là $d = \sqrt{6^2 + 8^2} = 10$ km.
d đúng. Độ dịch chuyển của xe khi đi rồi trở về vị trí ban đầu là $d = 0$.}
\end{ex}
...
{\True Người này dịch chuyển theo hướng Đông – Bắc.}
\loigiai{a đúng. Quãng đường đi được $s = 6 + 20 = 26$ km.
b sai. Độ dịch chuyển của người đó là $d = \sqrt{6^2 + 20^2} = \sqrt{36 + 400} = \sqrt{436} \approx 20,88$ km.
c sai. Hướng dịch chuyển của người đó là $\alpha = \arctan(20/6) \approx 73,3$ độ so với hướng Đông.
d đúng. Người này dịch chuyển theo hướng Đông – Bắc.}
\end{ex}
