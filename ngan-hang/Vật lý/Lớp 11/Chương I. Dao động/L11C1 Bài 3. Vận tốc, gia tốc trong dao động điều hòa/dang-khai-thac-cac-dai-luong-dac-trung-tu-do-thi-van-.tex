...
% Bài: L11C1 Bài 3. Vận tốc, gia tốc trong dao động điều hòa · Khai thác các đại lượng đặc trưng từ đồ thị vận tốc – thời gian hoặc gia tốc – thời gian
% ===== Câu 1 =====
% ID: L11C1B3-89-DS
% Mức: TH
\dangbt{Khai thác các đại lượng đặc trưng từ đồ thị vận tốc – thời gian hoặc gia tốc – thời gian}
\begin{ex}Một vật thực hiện dao động điều hòa với phương trình li độ là $x=5\cos(3t)$ (cm). Hãy xác định các phát biểu đúng về chuyển động của vật.
\choiceTF
{\True Vận tốc của vật là $v=-15\sin(3t)$ (cm/s).}
{\True Gia tốc của vật là $a=-45\cos(3t)$ (cm/s$^2$).}
{\True Tốc độ cực đại của vật là $15$ (cm/s).}
{Gia tốc của vật bằng $0$ khi vật ở vị trí biên.}
\loigiai{
Từ phương trình li độ $x=5\cos(3t)$ (cm), ta có:
1. Phương trình vận tốc:
$v = x' = \frac{d}{dt}(5\cos(3t)) = 5 \cdot (-3\sin(3t)) = -15\sin(3t)$ (cm/s).
Vậy phát biểu 1 là đúng.
2. Phương trình gia tốc:
$a = v' = \frac{d}{dt}(-15\sin(3t)) = -15 \cdot (3\cos(3t)) = -45\cos(3t)$ (cm/s$^2$).
Vậy phát biểu 2 là đúng.
3. Tốc độ cực đại:
Từ $v = -15\sin(3t)$, ta thấy tốc độ cực đại là $v_{max} = |-15| = 15$ (cm/s).
Hoặc $v_{max} = \omega A = 3 \cdot 5 = 15$ (cm/s).
Vậy phát biểu 3 là đúng.
4. Gia tốc bằng $0$ ở vị trí biên:
Vị trí biên là khi $x = \pm A = \pm 5$ (cm).
Tại vị trí biên, gia tốc có độ lớn cực đại: $a_{max} = \omega^2 A = 3^2 \cdot 5 = 45$ (cm/s$^2$).
Gia tốc bằng $0$ khi vật đi qua vị trí cân bằng ($x=0$).
Vậy phát biểu 4 là sai.
Các phát biểu đúng là 1, 2, 3. Do đó, chọn phương án A.
}
\end{ex}
