...
% ID: L11C1B3-11-DS
% Mức: VD
\begin{ex}[TTN] Một chất điểm dao động điều hoà trên đoạn thẳng dài $10\,\text{cm}$ và thực hiện được 50 dao động trong thời gian $78,5\,\text{s}$.
\choiceTF
...
\item (Sai) Tần số góc dao động của chất điểm là $\text{4}\pi \text{ rad/s}\text{.}$. (Vì): Phát biểu này sai. Ta có $N=\frac{\Delta t}{T}\Rightarrow T=\frac{\Delta t}{N}=\frac{78,5}{50}=1,57=\frac{\pi }{2}\text{ }s\Rightarrow \omega =\frac{2\pi }{T}=\text{4 rad/s}\text{.}$
...
\loigiai{
Phương trình gia tốc của vật dao động điều hòa là $a = -\omega^2 x$.
Độ lớn của gia tốc là $|a| = \omega^2 |x|$. 
Vì $x$ là li độ của vật, nên $|x|$ có giá trị từ $0$ (tại vị trí cân bằng) đến $A$ (tại vị trí biên). Do đó, độ lớn gia tốc $|a|$ sẽ cực tiểu khi $|x|$ cực tiểu, tức là khi $|x|=0$. Điều này xảy ra khi vật đi qua vị trí cân bằng. Vậy, độ lớn gia tốc cực tiểu khi vật qua vị trí cân bằng.
}
\end{ex}
...
% Mức: NB
\dangbt{Liên hệ li độ - gia tốc}
\begin{ex}Gia tốc của một vật dao động điều hòa có giá trị bằng không khi nào?
\choice
{Vận tốc của vật bằng không.}
{Vật ở vị trí có li độ cực đại.}
{Vật ở vị trí có pha dao động cực đại.}
{\True Vật ở vị trí cân bằng (li độ bằng không).}
\loigiai{
Gia tốc của vật dao động điều hòa được biểu diễn bởi công thức $a = -\omega^2 x$, trong đó $a$ là gia tốc, $\omega$ là tần số góc và $x$ là li độ của vật.
Để gia tốc $a$ có giá trị bằng không, ta có:
$a = 0 \Rightarrow -\omega^2 x = 0$
Vì $\omega$ là tần số góc và $\omega \neq 0$, nên điều kiện để $a=0$ là $x=0$.
Li độ $x=0$ tương ứng với vị trí cân bằng của vật dao động điều hòa.
Xét các phương án:
A. Vận tốc của vật bằng không khi vật ở vị trí biên (li độ cực đại hoặc cực tiểu), lúc đó gia tốc có giá trị cực đại hoặc cực tiểu.
B. Vật ở vị trí có li độ cực đại (biên dương hoặc biên âm), lúc đó gia tốc có giá trị cực tiểu hoặc cực đại.
C. Pha dao động cực đại không phải là một khái niệm vật lý chuẩn trong dao động điều hòa để xác định vị trí cụ thể của vật.
D. Vật ở vị trí cân bằng (li độ bằng không), lúc đó gia tốc bằng không. Đây là đáp án đúng.
}
\end{ex}
