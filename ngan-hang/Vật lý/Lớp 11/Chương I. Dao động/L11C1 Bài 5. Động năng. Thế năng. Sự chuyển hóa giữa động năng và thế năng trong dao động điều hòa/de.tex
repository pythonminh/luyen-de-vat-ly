...
% ID: L11C1B5-110-DS
% Mức: TH
\dangbt{Tính động năng, thế năng và cơ năng của dao động điều hòa}
\begin{ex}
% ID: L11C1B5-110-DS
% Mức: TH
...
% ID: L11C1B5-04-TLN
% Mức: TH
\dangbt{Lý thuyết và sự chuyển hóa năng lượng trong dao động điều hòa}
\begin{ex}
% ID: L11C1B5-04-TLN
% Mức: TH
Con lắc lò xo có độ cứng $50\,\text{N}$ /m và biên độ $4\,\text{cm}$. Cơ năng theo đơn vị $J$ bằng bao nhiêu?
...
% ID: L11C1B5-07-TLN
% Mức: VD
\dangbt{Năng lượng của con lắc đơn}
\begin{ex}
% ID: L11C1B5-07-TLN
% Mức: VD
...
% ID: L11C1B5-100-TN
% Mức: VD
\dangbt{Xác định các thông số dao động từ năng lượng}
\begin{ex}
% ID: L11C1B5-100-TN
% Mức: VD
