...
% ID: L11C1B2-10-TLN
% Mức: TH
\dangbt{Xác định tần số dao động dựa vào số dao động toàn phần và thời gian}

\begin{ex}
% ID: L11C1B2-10-TLN
% Mức: TH
Một vật thực hiện $12$ dao động toàn phần trong $6\,\mathrm{s}$. Tần số dao động của vật theo đơn vị Hz bằng bao nhiêu?
...
f=\frac{N}{t}.
\]
Với $N=12$ dao động và $t=6\,\mathrm{s}$, ta có
\[
f=\frac{12}{6}=2\,\mathrm{Hz}.
\]
...
% ID: L11C1B2-11-TLN
% Mức: VD
Một vật thực hiện $18$ dao động toàn phần trong $9\,\mathrm{s}$. Tần số dao động của vật theo đơn vị Hz bằng bao nhiêu?
...
f=\frac{N}{t}.
\]
Thay $N=18$ và $t=9\,\mathrm{s}$:
\[
f=\frac{18}{9}=2\,\mathrm{Hz}.
\]
Vậy đáp án là $\boxed{2}$.
}
\end{ex}
...
% ID: L11C1B2-12-TLN
% Mức: VD
Một vật thực hiện $24$ dao động toàn phần trong $12\,\mathrm{s}$. Tần số dao động của vật theo đơn vị Hz bằng bao nhiêu?
...
f=\frac{N}{t}.
\]
Thay $N=24$ và $t=12\,\mathrm{s}$:
\[
f=\frac{24}{12}=2\,\mathrm{Hz}.
\]
Vậy đáp án là $\boxed{2}$.
}
\end{ex}
...
% Mức: VDC
Một vật dao động điều hòa. Trong $4$ giây, vật thực hiện được $20$ dao động toàn phần. Biết biên độ dao động là $3\,\mathrm{cm}$. Tại thời điểm ban đầu ($t=0$), vật đi qua vị trí cân bằng theo chiều dương. Viết phương trình li độ của vật.

\choice
{$x=3\cos(10\pi t)$ cm}
{\True $x=3\sin(10\pi t)$ cm}
{$x=3\cos\left(10\pi t-\dfrac{\pi}{2}\right)$ cm}
{$x=3\sin(5\pi t)$ cm}

\loigiai{
Trong thời gian $t=4\,\mathrm{s}$, vật thực hiện được $N=20$ dao động toàn phần nên tần số dao động là
\[
f=\frac{N}{t}=\frac{20}{4}=5\,\mathrm{Hz}.
\]
...
Tại $t=0$, vật đi qua vị trí cân bằng theo chiều dương nên
\[
x(0)=0,\qquad v(0)>0.
\]
...
Suy ra
\[
x=3\cos\left(10\pi t-\frac{\pi}{2}\right)
=3\sin(10\pi t)\,\mathrm{cm}.
\]

Vậy phương trình li độ của vật là
\[
\boxed{x=3\sin(10\pi t)\,\mathrm{cm}}.
\]
}
\end{ex}
