...
\item (Sai) Dao động điều hòa là dao động trong đó li độ của vật là một hàm hay sin hay hàm tan theo thời gian. (Vì): ao động điều hòa có li độ là hàm sin hoặc cos, không phải là hàm tan
...
\item (Sai) Đại lượng $\omega t + \varphi$ được gọi là pha ban đầu của dao động. (Vì): Đại lượng $(\omega t + \varphi)$ là pha dao động tại thời điểm $t$, còn pha ban đầu là $\varphi$
\end{itemchoice}
}
\end{ex}
...
\item (Sai) Pha ban đầu của dao động sau khi chuẩn hóa là  $x = -5\cos\left(10\pi t + \dfrac{\pi}{6}\right) = 5\cos\left(10\pi t + \dfrac{\pi}{6} - \pi\right) = 5\cos\left(10\pi t - \dfrac{5\pi}{6}\right)$
\end{itemchoice}
}
\end{ex}
