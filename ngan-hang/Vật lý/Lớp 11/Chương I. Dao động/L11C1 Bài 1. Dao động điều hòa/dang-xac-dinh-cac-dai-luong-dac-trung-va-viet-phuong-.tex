...
% ID: L11C1B1-50-TN
% Mức: TH
\begin{ex}Một vật dao động điều hòa có đồ thị li độ theo thời gian như sau: biên độ dao động là $6 \text{ cm}$. Từ thời điểm $t = 0$ đến $t = 0,5 \text{ s}$, vật thực hiện được một dao động toàn phần. Hãy xác định tần số dao động của vật.
\choice
{$f = 0,5 \text{ Hz}$}
{$f = 1 \text{ Hz}$}
{\True $f = 2 \text{ Hz}$}
{$f = 4 \text{ Hz}$}
\loigiai{
Theo đề bài, vật thực hiện một dao động toàn phần trong khoảng thời gian $0,5 \text{ s}$.
Điều này có nghĩa là chu kì dao động $T = 0,5 \text{ s}$.
Tần số dao động $f$ được tính bằng công thức $f = \frac{1}{T}$.
...
% ID: L11C1B1-59-TN
% Mức: VD
\begin{ex}Một vật dao động điều hòa có đồ thị biểu diễn sự phụ thuộc của li độ vào thời gian. Quan sát đồ thị, ta thấy vật có li độ lớn nhất là $5 \text{ cm}$ khi $t = 0$. Lần đầu tiên vật đi qua vị trí cân bằng (li độ $0 \text{ cm}$) là tại thời điểm $t = 0,05 \text{ s}$. Hãy xác định phương trình dao động của vật.
\choice
{A. $x = 5\sin(10\pi t) \text{ cm}$}
{B. $x = 5\cos(10\pi t + \frac{\pi}{2}) \text{ cm}$}
{\True C. $x = 5\cos(10\pi t) \text{ cm}$}
{D. $x = 5\sin(10\pi t + \frac{\pi}{4}) \text{ cm}$}
\loigiai{
Từ thông tin đề bài:
- Biên độ dao động $A = 5 \text{ cm}$ (li độ cực đại).
- Tại thời điểm ban đầu $t = 0$, vật có li độ $x = 5 \text{ cm}$, tức là vật đang ở vị trí biên dương. Do đó, pha ban đầu $\varphi = 0$.
- Vật đi từ vị trí biên dương ($x = A$) đến vị trí cân bằng ($x = 0$) lần đầu tiên mất khoảng thời gian $t = 0,05 \text{ s}$. Khoảng thời gian này tương ứng với một phần tư chu kì dao động, tức là $\frac{T}{4} = 0,05 \text{ s}$.
Từ đó, chu kì dao động là $T = 4 \times 0,05 = 0,2 \text{ s}$.
Tần số góc của dao động là $\omega = \frac{2\pi}{T} = \frac{2\pi}{0,2} = 10\pi \text{ rad/s}$.
Thay các giá trị $A = 5 \text{ cm}$, $\omega = 10\pi \text{ rad/s}$ và $\varphi = 0$ vào phương trình dao động điều hòa tổng quát $x = A\cos(\omega t + \varphi)$, ta được:
$x = 5\cos(10\pi t + 0) \text{ cm}$
Hay $x = 5\cos(10\pi t) \text{ cm}$.
Vậy, phương trình dao động của vật là $x = 5\cos(10\pi t) \text{ cm}$.
Đối chiếu với các phương án, đáp án đúng là C.
}
\end{ex}
...
% ID: L11C1B1-61-TN
% Mức: VD
\begin{ex}Một vật dao động điều hòa có đồ thị li độ theo thời gian như sau: tại thời điểm ban đầu $t=0$, vật ở vị trí $x=4$ cm; sau đó $0,5$ giây, vật đi qua vị trí cân bằng ($x=0$); và tại $t=1$ s, vật đạt li độ $x=-4$ cm. Hãy xác định biên độ và chu kỳ của dao động này.
\choice
{Biên độ $8$ cm, chu kỳ $1$ s.}
{Biên độ $4$ cm, chu kỳ $4$ s.}
{\True Biên độ $4$ cm, chu kỳ $2$ s.}
{Biên độ $8$ cm, chu kỳ $2$ s.}
\loigiai{
Từ dữ kiện đề bài:
Tại $t=0$, $x=4$ cm. Đây là giá trị li độ dương lớn nhất mà vật đạt được trước khi về $x=0$ tại $t=0,5$ s. Do đó, biên độ của dao động là $A=4$ cm.
Tại $t=0$, vật ở vị trí biên dương ($x=A$).
Tại $t=1$ s, vật ở vị trí biên âm ($x=-A$).
Khoảng thời gian từ $t=0$ đến $t=1$ s là $1$ s. Trong khoảng thời gian này, vật đi từ biên dương sang biên âm, tức là đi được nửa chu kỳ.
Vậy, ta có:
$\frac{T}{2} = 1$ s
$T = 2$ s
Kết luận: Biên độ của dao động là $4$ cm và chu kỳ là $2$ s.
Chọn phương án C.
}
\end{ex}
