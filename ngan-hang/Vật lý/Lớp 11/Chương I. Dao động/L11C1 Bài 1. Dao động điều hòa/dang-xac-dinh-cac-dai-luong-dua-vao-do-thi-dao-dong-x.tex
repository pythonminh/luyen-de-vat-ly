...
% ID: L11C1B1-236-TLN
% Mức: TH
\begin{ex}% ID: L11C1B1-236-TLN
% Mức: TH
Trên đồ thị li độ–thời gian của một vật dao động điều hòa, hai đỉnh dương liên tiếp xuất hiện tại $t_1 = 1$ s và $t_2 = 2$ s. Chu kì dao động của vật là bao nhiêu?
\shortans{1}
\loigiai{
Hai đỉnh dương liên tiếp trên đồ thị li độ–thời gian biểu thị hai thời điểm vật đạt li độ cực đại dương (biên độ A) liên tiếp. Khoảng thời gian giữa hai lần liên tiếp vật đạt li độ cực đại dương chính là một chu kì dao động $T$.
Do đó, $T = t_2 - t_1 = 2 \text{ s} - 1 \text{ s} = 1 \text{ s}$.
}
\end{ex}
