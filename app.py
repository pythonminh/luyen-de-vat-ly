...
APP_VERSION = "V67_AI_HINT_LOADING_UI_2026_06_02"
...
function hintButtonLabel(){return USER.is_admin?'🔍 AI kiểm tra':(USER.is_vip?'💡 Gợi ý AI (VIP)':'💡 Gợi ý AI')}
