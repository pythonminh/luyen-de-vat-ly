...
APP_VERSION = "V210_ADMIN_GPT_DETECT_EDIT_LEVEL_2026_06_10"
...
def version():
    return jsonify({
        ...
        "retry_shuffle": True,
        "routes": ["/login", "/register", "/logout", "/share", "/d/<made>", "/api/meta", "/api/start", "/api/start-random", "/api/submit", "/api/question/create", "/api/question/update", "/api/question/delete", "/api/question/dedupe", "/api/question/lookup", "/api/infographic-prompt", "/api/infographic-generate", "/api/ai/detect-level", "/api/latex/import"]
    })
