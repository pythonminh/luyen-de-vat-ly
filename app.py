...
APP_VERSION = "V12_RETRY_UI_HIGHLIGHT_2026_06_02"
...
<script>
let META=null,CATALOG=[],USER={},SID='',QUESTIONS=[],CUR=0,ANSWERS={},SUBMITTED=false,RESULTS={},CURRENT_MADE='',START_IS_RETRY=false;
