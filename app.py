...
APP_VERSION = "V155_FIX_MATHJax_SOLUTION_INFOGRAPHIC_2026_06_06"
...
def build_gemini_infographic_prompt(q: Dict[str, Any]) -> str:
    ...
    lines.extend(
        [
            ...
            "• Công thức / số liệu: viết dạng chữ thường dễ đọc (m·c·Δt, Q_cc = Q_thu/H ≈ …) — KHÔNG dùng mã LaTeX ($, \\frac, \\text, \\cdot…)",
            "",
            "═══ YÊU CẦU THIẾT KẾ ═══",
