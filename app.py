...
APP_VERSION = "V144_ADMIN_DETAIL_AI_2026_06_06"
...
def build_ai_admin_review_prompt_2026(q: Dict[str, Any], user_answer: Any) -> str:
    ...
    return "\n".join(
        [
            "ADMIN kiểm tra ngân hàng câu — lời giải TRỌN VẸN, CHI TIẾT từng ý (KHÁC gợi ý VIP ngắn).",
            "",
