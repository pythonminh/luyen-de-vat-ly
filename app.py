...
APP_VERSION = "V109_RESP_MCQ_LAYOUT_2026_06_06"
...
function mcqUsesSplit(q){return !!(q&&q.Dang==='Trắc nghiệm'&&String(q.HinhAnh||'').trim())}
...
function ensureFullModeOverrides(){
    ...
    st.textContent=
        ...
        "body.fullde-mode .mcqSplit{grid-template-columns:minmax(0,1.2fr) minmax(260px,0.8fr)!important;gap:16px!important}"+
        ...
        "@media(min-width:1200px){body.fullde-mode .dsSolutionTn{grid-template-columns:repeat(4,minmax(0,1fr))!important}body.fullde-mode .mcqSplit{grid-template-columns:minmax(0,1.1fr) minmax(300px,0.9fr)!important}}"+
