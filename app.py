...
APP_VERSION = "V110_DS_IMG_SPLIT_2026_06_06"
...
function usesImgSplit(q){return !!(q&&String(q.HinhAnh||'').trim()&&(q.Dang==='Trắc nghiệm'||q.Dang==='Đúng sai'))}
...
function ensureFullModeOverrides(){
    ...
    st.textContent=
        ...
        "body.fullde-mode .mcqSplit,body.fullde-mode .mcqSplitDs{grid-template-columns:minmax(0,1.2fr) minmax(260px,0.8fr)!important;gap:16px!important}"+
        ...
        "@media(min-width:1200px){body.fullde-mode .dsSolutionTn{grid-template-columns:repeat(4,minmax(0,1fr))!important}body.fullde-mode .mcqSplit{grid-template-columns:minmax(0,1.1fr) minmax(300px,0.9fr)!important}body.fullde-mode .mcqSplitDs{grid-template-columns:minmax(0,1fr) minmax(340px,1fr)!important}}"+
