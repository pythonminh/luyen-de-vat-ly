...
APP_VERSION = "V253_TOP_SUBJECT_TABS_MOBILE_TEST_2026_06_12"
...
function v253FindSubject(kind){let arr=v253SubjectOptions();for(let v of arr){if(v253SubjectKindFromName(v)===kind)return v}return kind==='math'?'Toán':(kind==='physics'?'Vật lí':'')}
