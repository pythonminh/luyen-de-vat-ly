...
APP_VERSION = "V221_ADMIN_LEARNING_BOARD_TEST_2026_06_11"
...
function syncAdminLearningBoard(q){
    ...
    if(scope){
        ...
        scope.innerHTML=parts.length?parts.join('<br>'):'Câu này chưa đủ Mon/Lop/Chuong/BaiHoc/DangBaiTap.';
    }
}
