...
APP_VERSION = "V16_FULLSCREEN_FOCUS_SOL_2026_06_02"
...
<script>
let META=null,CATALOG=[],USER={},SID='',QUESTIONS=[],CUR=0,ANSWERS={},SUBMITTED=false,RESULTS={},CHECKED={},LOCKED_Q={},CURRENT_MADE='',START_IS_RETRY=false,QUIZ_ELAPSED=0,QUIZ_TIMER=null,FS_SOL_FORCE=null;
...
function toggleQuizFullscreen(){let el=document.getElementById('quiz');if(!document.fullscreenElement){if(el.requestFullscreen)el.requestFullscreen()}else{if(document.exitFullscreen)document.exitFullscreen()}}
...
document.addEventListener('fullscreenchange',()=>{if(!document.fullscreenElement){FS_SOL_FORCE=null;renderQuestion()}});
