...
def page(title: str, body: str, cinema: bool = False) -> Response:
    ...
    mj = (
        ...
        "if(tb&&nv){tb.onclick=function(){var on=document.querySelector('.top').classList.toggle('nav-open');tb.setAttribute('aria-expanded',on?'true':'false');tb.textContent=on?'✕':'☰';ldvlSyncHeaderH();};}"
